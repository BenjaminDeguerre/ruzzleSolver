...
{
	char *string = "T1LDR1  A1  S1MTE1LTN1  C3LTE1  U1  R1  I1  L2MDS1  O1MDP3  S1  ";
...
{
	return ((NULL == CU_add_test(pSuite, "G_createGrid", test_1_Grid)) || (NULL == CU_add_test(pSuite, "extraction d'une case de la grille (troisième)", test_2_Grid)) || (NULL == CU_add_test(pSuite, "S_defineSquare(c,b2MD) == 2 ", test_3_Grid)) || (NULL == CU_add_test(pSuite, "S_defineSquare(c,b2MD) == MD", test_4_Grid)));
}
