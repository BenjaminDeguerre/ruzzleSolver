...
{
	return ((NULL == CU_add_test(pSuite, "AS_createAdjacentSquares()", test_1_AdjacentSquares)) || (NULL == CU_add_test(pSuite, "AS_addSquare(AS_AdjacentSquares *adjacentSquare, S_SQUARE *square)", test_2_AdjacentSquares)) || (NULL == CU_add_test(pSuite, "S_defineSquare(c,b2MD) == 2 ", test_3_AdjacentSquares)) || (NULL == CU_add_test(pSuite, "S_defineSquare(c,b2MD) == MD", test_4_AdjacentSquares)) || (NULL == CU_add_test(pSuite, "S_defineSquare(c,b2MD) == MD", test_5_AdjacentSquares)));
}
