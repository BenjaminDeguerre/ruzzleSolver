...
/**
 *	\fn void BT_setRightChild(BT_BinaryTree *myBT, BT_BinaryTree
 **rightChild)
 ...
 *	\param *leftChild pointeur sur un arbre, new fils gauche du node
 *	\param *rightChild pointeur sur un arbre, new fils droit du node
 *	\param *node pointeur sur un node, new root
 ...
 *	\brief Permet de delete la root d'un arbre binaire de recherche (deux
 *sous arbre sont "créés")
 *	\param *a pointeur sur un arbre, celui dont on veut delete la root
 *	\param *leftChild pointeur sur un arbre, (sortie) sous arbre gauche
 *résultant de la suppression de la root
 *	\param *rightChild pointeur sur un arbre, (sortie) sous arbre droit
 *résultant de la suppression de la root
 *	\param freeNode fonction permettant de libérer l'espace mémoire occupé
 *par le node
 *	\return void
 */
